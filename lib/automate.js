...
runbook.Automator.clickElement = function(el) {
  el.click();
}

runbook.Automator.setValue = function(input, value) {
...
runbook.Automator.fillFormInput = function (match) {
...
runbook.Automator.fillMultipleElementInput = function (inputs, match) {
...
runbook.Automator.fillDate = function (inputs, match) {
...
runbook.Automator.submitForm = function (form_tree, mockSubmit) {
  let submit = form_tree.getBestGuessSubmit();
  console.log('Submitting');
  console.log(submit);

  console.log('but not really submitting');
  highlightElement(submit.element);
  if (!mockSubmit)
